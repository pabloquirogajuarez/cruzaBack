...
class CreateHistorialBonificacionesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('historial_bonificaciones', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('historial_bonificaciones');
    }
}
