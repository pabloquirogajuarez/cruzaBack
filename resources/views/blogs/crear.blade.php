                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                   ...
                                   <input type="text" name="cuil" class="form-control" placeholder="Ingrese el CUIL">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                   ...
                                   <textarea class="form-control" name="domicilio" style="height: 100px" placeholder="Ingrese el domicilio"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                   ...
                                   <input type="number" name="vacaciones" class="form-control" placeholder="Ingrese los días de vacaciones">
                                </div>
                            </div>
