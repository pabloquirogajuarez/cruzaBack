...
$retribucionEnLetras = numeroALetras($retribucion);
?>
...
<head>
    ...
    <title>Bonificación - Triplicado</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="recibo-body">
                        <div class="row mb-1">
                            <div class="col-6 text-end">
                                <p><strong>Periodo:</strong> Desde {{ $fechaDesde }} hasta {{ $fechaHasta }}</p>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-6">
                        ...
                        <div class="row mb-1">
                            <div class="col-12">
                                <p><strong>Bonificación:</strong> <span class="ms-5">${{ number_format($retribucion, 2, ',', '.') }}</span></p>
                                <p><strong>Retenciones:</strong></p>
                                <ul>
                                    <li><strong>RET. LEY 28565/04:</strong> -</li>
                                    <li><strong>RET. LEY 28565/04:</strong> -</li>
                                    <li><strong>RET. LEY 28565/04:</strong> -</li>
                                    <li><strong>Otras retenciones:</strong> -</li>
                                </ul>
                                <p><strong>Neto a Cobrar:</strong> <span class="ms-5">${{ number_format($retribucion, 2, ',', '.') }}</span></p>
                            </div>
                            <p><strong>Recibi conforme la suma de pesos:</strong> {{ $retribucionEnLetras }} PESOS</p>
