...
public class CBebidas {
    ...
    public ResponseEntity<Bebidas> getById(@PathVariable("id") int id) {
        ...
        Bebidas hYs = shys.getOne(id).get();
    ...
    public ResponseEntity<?> create(@RequestBody dtoBebidas dtohys) {
        ...
        Bebidas hYs = new Bebidas(dtohys.getNombre(), dtohys.getPorcentaje());
        shys.save(hYs);
