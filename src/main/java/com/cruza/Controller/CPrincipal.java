...
public class CPrincipal {
    ...
    public ResponseEntity<Principal> getById(@PathVariable("id") int id){
        ...
        Principal experiencia = sExperiencia.getOne(id).get();
    ...
    public ResponseEntity<?> create(@RequestBody dtoPrincipal dtoexp){      
        ...
        Principal experiencia = new Principal(dtoexp.getNombreE(), dtoexp.getDescripcionE(), dtoexp.getFechaInicioE(), dtoexp.getFechaFinE());
